function doleds()
    ...
    greenID = addCell("BM greenledon","bmod/ledgreenon.png",function() return true end)
    blueID = addCell("BM blueledon","bmod/ledblueon.png",function() return true end)
    magentID = addCell("BM magentaledon","bmod/ledmagentaon.png",function() return true end)
    yellID = addCell("BM yellowledon","bmod/ledyellowon.png",function() return true end)
    cyaID = addCell("BM cyanledon","bmod/ledcyanon.png",function() return true end)
